...
*
*/
// TODO: 2021/3/23 主构造函数
public class PositionCategoryDataSource(private var mCid:Int): PageKeyedDataSource<String, MainArticle>(){
    ...
    override fun loadInitial(
        ...
        GlobalScope.launch(Dispatchers.IO) {
            val result = NetRepository.getProjectInfo(mPage, mCid)
            when(result){
...
//                            t.datas[i].title,
//                            t.datas[i].envelopePic,t.datas[i].desc)
//
//                        mList.add(mainArticle)
//                    }
//                    callback.onResult(mList,"before","after")
